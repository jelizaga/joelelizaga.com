...
that point there's a great likelihood that our web-traversing AI models will be 
training on the output of web-traversing AI. 

This could result in an awesome singularity-like renaissance that ultimately
...
through unceasing firehoses of cacophonous content, *on top of* drowning out the
variety and diversity of human expression.

So why not keep posting? If anything, this is a great time to be expressive;
to try and push some humane paradigm that speaks to one's values, bit by bit,
and populate discourse with variety.
...
There's no all-or-nothing; AI will be used to persuade people and architect
...
idea as there are miraculously divergent permutations of *us*—and I don't think 
there's anything inherently destructive about that—about feeding these models 
with the sincere variety and diversity borne of just being human; just a greater 
amount of
risk as awesome capabilities become more accessible.
...
I'll try to keep it as cool, insightful, and interesting as possible.
