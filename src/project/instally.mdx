...
<NNCarousel
  ...
  images={[
    ...
    {
      src: "/img/project/instally/debian-updating-apt.png",
    ...
    },
    {
      ...
      caption: "After finishing an installation run, instally wants you to feel accomplished—enjoy the report breaking down which packages were installed (and which ones could not be installed)."
    }
  ]}
/>
...
The UX content of `instally` draws some from UX writing principles:
