...
headerImgSrc: "../../img/project/noonoo-design-language/header.jpg"
...
export const mediaPath = "/img/projects/noonoo-design-language";
...
<Media
  src={`${mediaPath}/tahoma-white.jpg`}
...
<Media
  src={`${mediaPath}/lawetlatla-ash.jpg`}
...
<Media
  src={`${mediaPath}/spectacular-red.jpg`}
...
<Media
  src={`${mediaPath}/rain-city-emerald.jpg`}
...
<Media
  arr={[
    {
      src: `${mediaPath}/dark-mode.jpg`,
      alt: "Noonoo Design Language in dark mode."
    },
    {
      src: `${mediaPath}/light-mode.jpg`,
...
<Media
  src={`${mediaPath}/octostar-spectacular-red.svg`}
