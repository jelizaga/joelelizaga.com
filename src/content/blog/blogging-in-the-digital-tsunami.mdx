...
headerImgSrc: "../../img/blog/blogging-in-the-digital-tsunami/cyberspace-tsunami.png"
pubDate: 2023-08-11
tags: [ai, hci, creativity, diversity, writing]
---
import Media from "../../components/Media/Media.astro";
export const mediaPath = "/img/blog/blogging-in-the-digital-tsunami"
...
<Media
  arr={[
    ...
    {
      src: `${mediaPath}/human-kayak.jpeg`,
...
<Media 
  src={`${mediaPath}/data-kaiju.png`}
  alt="A cyber kaiju reminiscent of Godzilla devouring mythical amounts of data."
  float="right"
  caption="Another analogy; AI is a cyber-kaiju that devours data to grow in capability."
/>
...
<Media
  src={`${mediaPath}/clay-fingerprint.png`}
...
<Media
  src={`${mediaPath}/kaiju-computer.png`}
...
<Media
  src={`${mediaPath}/earth-consumed.png`}
...
<Media
  src={`${mediaPath}/fingerprint-mosaic.png`}
...
<Media
  src={`${mediaPath}/cyberspace-earth.png`}
  alt="A clay pot with a human fingerprint pressed into its surface."
  float="right"
/>
